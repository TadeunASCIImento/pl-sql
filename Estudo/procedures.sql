...
-------------------------------------------------------------
-- Cria uma procedure para realizar um INSERT.
CREATE OR REPLACE PROCEDURE PROC_INSERIR_ALUNO
  (P_MATRICULA ALUNOS.MATRICULA%TYPE,
   P_NOME ALUNOS.NOME%TYPE)
   IS
   BEGIN
   INSERT INTO ALUNOS(MATRICULA,NOME)VALUES(P_MATRICULA,P_NOME);
   EXCEPTION
   WHEN DUP_VAL_ON_INDEX THEN
   DBMS_OUTPUT.PUT_LINE('NÚMERO DE MATRÍCULA JÁ EXISTE!');
   END;
   -- executa a procedure
   EXECUTE PROC_INSERIR_ALUNO('2217202040','Aline');
